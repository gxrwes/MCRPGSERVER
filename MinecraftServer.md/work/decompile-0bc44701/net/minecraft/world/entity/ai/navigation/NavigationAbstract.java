...
public abstract class NavigationAbstract {
    ...
    protected void trimPath() {
        if (this.path != null) {
            for (int i = 0; i < this.path.getNodeCount(); ++i) {
                ...
                if (iblockdata.is((Tag) TagsBlock.CAULDRONS)) {
    ...
    public void recomputePath(BlockPosition blockposition) {
        if (this.path != null && !this.path.isDone() && this.path.getNodeCount() != 0) {
            ...
            if (blockposition.closerThan((IPosition) vec3d, (double) (this.path.getNodeCount() - this.path.getNextNodeIndex()))) {
                this.recomputePath();
            }
