...
public class PlayerChunkMap extends IChunkLoader implements PlayerChunk.e {
    ...
    private static boolean isChunkInEuclideanRange(ChunkCoordIntPair chunkcoordintpair, EntityPlayer entityplayer, boolean flag, int i) {
        int j;
        int k;
        ...
        if (flag) {
            ...
            j = SectionPosition.blockToSectionCoord(entityplayer.getBlockX());
            k = SectionPosition.blockToSectionCoord(entityplayer.getBlockZ());
        }

        return isChunkInEuclideanRange(chunkcoordintpair, j, k, i);
    }

    private static boolean isChunkInEuclideanRange(ChunkCoordIntPair chunkcoordintpair, int i, int j, int k) {
        int l = chunkcoordintpair.x;
        int i1 = chunkcoordintpair.z;

        return isChunkInEuclideanRange(l, i1, i, j, k);
    }

    public static boolean isChunkInEuclideanRange(int i, int j, int k, int l, int i1) {
        int j1 = i - k;
        int k1 = j - l;
        int l1 = i1 * i1 + i1;
        int i2 = j1 * j1 + k1 * k1;
    ...
    private static boolean isChunkOnEuclideanBorder(ChunkCoordIntPair chunkcoordintpair, EntityPlayer entityplayer, boolean flag, int i) {
        int j;
        int k;
        ...
        return isChunkOnEuclideanBorder(chunkcoordintpair.x, chunkcoordintpair.z, j, k, i);
    }

    private static boolean isChunkOnEuclideanBorder(int i, int j, int k, int l, int i1) {
        return !isChunkInEuclideanRange(i, j, k, l, i1) ? false : (!isChunkInEuclideanRange(i + 1, j, k, l, i1) ? true : (!isChunkInEuclideanRange(i, j + 1, k, l, i1) ? true : (!isChunkInEuclideanRange(i - 1, j, k, l, i1) ? true : !isChunkInEuclideanRange(i, j - 1, k, l, i1))));
    }
    ...
    protected void setViewDistance(int i) {
        ...
        if (j != this.viewDistance) {
            ...
            while (objectiterator.hasNext()) {
                ...
                this.getPlayers(chunkcoordintpair, false).forEach((entityplayer) -> {
                    boolean flag = isChunkInEuclideanRange(chunkcoordintpair, entityplayer, true, k);
                    boolean flag1 = isChunkInEuclideanRange(chunkcoordintpair, entityplayer, true, this.viewDistance);
        ...
        if (Math.abs(i1 - i) <= this.viewDistance * 2 && Math.abs(j1 - j) <= this.viewDistance * 2) {
            ...
            for (int k2 = k1; k2 <= i2; ++k2) {
                for (int l2 = l1; l2 <= j2; ++l2) {
                    ...
                    boolean flag3 = isChunkInEuclideanRange(chunkcoordintpair, i1, j1, this.viewDistance);
                    boolean flag4 = isChunkInEuclideanRange(chunkcoordintpair, i, j, this.viewDistance);

                    this.updateChunkTracking(entityplayer, chunkcoordintpair, new MutableObject(), flag3, flag4);
                }
            }
        } else {
            ...
            for (k1 = i1 - this.viewDistance; k1 <= i1 + this.viewDistance; ++k1) {
                for (l1 = j1 - this.viewDistance; l1 <= j1 + this.viewDistance; ++l1) {
                    if (isChunkInEuclideanRange(k1, l1, i1, j1, this.viewDistance)) {
                        chunkcoordintpair1 = new ChunkCoordIntPair(k1, l1);
                        flag5 = true;
                        flag6 = false;
                        this.updateChunkTracking(entityplayer, chunkcoordintpair1, new MutableObject(), true, false);
                    }
                }
            }
            ...
            for (k1 = i - this.viewDistance; k1 <= i + this.viewDistance; ++k1) {
                for (l1 = j - this.viewDistance; l1 <= j + this.viewDistance; ++l1) {
                    if (isChunkInEuclideanRange(k1, l1, i, j, this.viewDistance)) {
                        chunkcoordintpair1 = new ChunkCoordIntPair(k1, l1);
                        flag5 = false;
                        flag6 = true;
                        this.updateChunkTracking(entityplayer, chunkcoordintpair1, new MutableObject(), false, true);
                    }
                }
            }
        }
    ...
    public List<EntityPlayer> getPlayers(ChunkCoordIntPair chunkcoordintpair, boolean flag) {
        ...
        while (iterator.hasNext()) {
            ...
            if (flag && isChunkOnEuclideanBorder(chunkcoordintpair, entityplayer, true, this.viewDistance) || !flag && isChunkInEuclideanRange(chunkcoordintpair, entityplayer, true, this.viewDistance)) {
                builder.add(entityplayer);
            }
        }
